/*
  ...
  /usr/bin/gengetopt --include-getopt --unamed-opts -i des-getopt.ggo -F des-getopt 
...
const char *gengetopt_args_info_purpose = "Command line options for the des executable\n\nBy Prof. Dr. Christoph Karg <christoph.karg@hs-aalen.de>";
