/*
  ...
  C:\Program Files (x86)\GnuWin32\bin\gengetopt.exe --include-getopt --unamed-opts -i kasiski-getopt.ggo -F kasiski-getopt 
...
const char *gengetopt_args_info_usage = "Usage: kasiski [OPTIONS]... [FILES]...";
      ...
      switch (c)
        ...
        case 'l':	/* Length of the ngrams to analyze.  */
          if (local_args_info.len_given)
            {
              fprintf (stderr, "%s: `--len' (`-l') option given more than once%s\n", argv[0], (additional_error ? additional_error : ""));
              goto failure;
            }
