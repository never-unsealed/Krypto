/*
  ...
  /usr/bin/gengetopt --include-getopt --unamed-opts -i aes-getopt.ggo -F aes-getopt 
...
const char *gengetopt_args_info_purpose = "Command line options for the aes executable\n\nBy Prof. Dr. Christoph Karg <christoph.karg@hs-aalen.de>";

const char *gengetopt_args_info_usage = "Usage: des [OPTION]... [FILE]...";
